  ...
  run: [
    // nvidia windows 
    {
      ...
      "params": {
        ...
        "message": [
          "uv pip install torch==2.3.0 torchvision==0.18.0 torchaudio==2.3.0 --index-url https://download.pytorch.org/whl/cu121 --force-reinstall",
          "uv pip install xformers==0.0.26.post1",
          "uv pip install torchao==0.3.0",
    ...
    // nvidia linux
    {
      ...
      "params": {
        ...
        "path": "{{args && args.path ? args.path : '.'}}",
        "message": [
         "uv pip install torch==2.10.0 torchvision==0.25.0 torchaudio==2.10.0 numpy==1.26.4 {{args && args.xformers ? 'xformers==0.0.35' : ''}} --index-url https://download.pytorch.org/whl/cu128 --force-reinstall",
    ...
    // amd linux (rocm)
    {
      ...
      "params": {
        ...
        "path": "{{args && args.path ? args.path : '.'}}",
        "message": [
          "uv pip install torch==2.10.0 torchvision==0.25.0 torchaudio==2.10.0 --index-url https://download.pytorch.org/whl/rocm6.3 --force-reinstall --no-deps",
          "uv pip install torchao==0.10.0"
        ]
      },
      "next": null
    ...
    // cpu
    {
      ...
      "params": {
        ...
        "path": "{{args && args.path ? args.path : '.'}}",
        "message": [
          "uv pip install torch==2.10.0 torchvision==0.25.0 torchaudio==2.10.0  numpy==1.26.4 --index-url https://download.pytorch.org/whl/cpu --force-reinstall --no-deps",
          "uv pip install torchao==0.10.0"
        ]
      }
    }
